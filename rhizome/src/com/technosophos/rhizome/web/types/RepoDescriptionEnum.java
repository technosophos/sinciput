...
import com.technosophos.rhizome.web.types.FieldDescription;
import com.technosophos.rhizome.web.types.RhizomeType;

public enum RepoDescriptionEnum implements RhizomeType {
	TYPE (
			"type", 
			"Type", 
