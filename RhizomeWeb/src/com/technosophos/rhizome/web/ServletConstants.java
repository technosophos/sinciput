...
/**
 * Basic constants that the {@link BaseRhizomeServlet} servlet needs.
 * This is meant to be generic enough to be portable to another app.
 * @author mbutcher
 *
 */
public class ServletConstants {
	...
	/** 
	  ...
	  * It is "__settings".
	  */
	 public static final String SETTINGS_REPO = "__settings";
}
