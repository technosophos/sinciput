...
/**
 * Servlet implementation class for Servlet: BaseRhizomeServlet.
 * 
 * This abstract class is designed to provide the basis for Rhizome-centered 
 * web applications.
 *
 */
 public class BaseRhizomeServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		params.put(ServletConstants.REQ_PARAM_SESSION, new BaseRhizomeSession(request.getSession(true)));
